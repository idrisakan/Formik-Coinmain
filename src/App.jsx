...
const App = () => {
  // Form gönderildiğinde FormData yöntemi ile verilere ulaşabilyorduk. Ama hat yönetimi yapmıyorduk. Hata yönetimi yapmak istersek kodları bizim yazdığımız senaryoda çok fazla kod tekrarı olacağı için formik & yup kütüphanelerini kullanarak bu formu yöneticez
  ...
  return (
    <div className="vh-100 vw-100 bg-dark text-white">
      <div className="container py-5">
        <h2 className="text-center">Coinmain</h2>
        <form
          ...
          <button disabled={formik.isSubmitting} className="my-5">Gönder</button>
        </form>
      </div>
    </div>
  )
